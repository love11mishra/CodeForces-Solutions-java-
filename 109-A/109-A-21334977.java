  ...
  //  static int gcd(int a,int b){return b==0?a:gcd(b,a%b);}  
	...
	/*static void ArrayPrint(int[]a){
	  ...
	  public static void main(String[]args)throws IOException{
		...
		int a=0,b=0,minn=1000000,a1=0;;
		for(int i=0;i<=n/7;i++){
			if((n-7*i)%4==0){
				a=(n-7*i)/4;
				if(a+i<minn){minn=a+i;b=i;a1=a;}
			}
		}
		if(a1+b==0){System.out.println(-1);return;}
		for(int i=0;i<a1;i++)op.print(4);
		for(int i=0;i<b;i++)op.print(7);
         op.close();
	}
}